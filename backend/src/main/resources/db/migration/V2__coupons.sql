...
SELECT '11111111-1111-1111-1111-111111111111', 'FRESH10', '10% fresh savings', 'percentage', 10, 299, 100, true
WHERE NOT EXISTS (SELECT 1 FROM coupons WHERE code = 'FRESH10');

INSERT INTO coupons (id, code, title, discount_type, discount_value, minimum_order, maximum_discount, active)
SELECT '22222222-2222-2222-2222-222222222222', 'FARM50', 'Flat ₹50 off', 'fixed', 50, 499, 50, true
WHERE NOT EXISTS (SELECT 1 FROM coupons WHERE code = 'FARM50');
