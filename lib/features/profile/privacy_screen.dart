      ...
      body: ListView(
        ...
        children: <Widget>[
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        emailVerified
                            ? 'Verified email • Encrypted & secured'
                            : 'Encrypted & secured authentication',
          ...
          const _PrivacyCard(
            ...
            text:
                'Your password and sign-in credentials are handled securely through encrypted backend authentication.',
          ),
          const _PrivacyCard(
